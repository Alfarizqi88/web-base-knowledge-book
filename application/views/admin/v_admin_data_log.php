                      ...
                      <?php foreach($data as $a)            
                        {
                          ...
                          ?>
                            ...
                            <tr>
                              ...
                              <td>
                                  <a href="<?php echo base_url('admin/aksi_admin/hapus_data_log')?>?id_log=<?php echo $a['id_log']?>&name_divisi=<?php echo $a['divisi'] ?>" class="btn btn-danger" ><i class="fas fa-trash"></i></a>
                              </td>
                            </tr>
                      <?php
                        }
