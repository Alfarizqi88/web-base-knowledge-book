        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <?php foreach($divisi as $ct)            
                        { ?>
            <h1 class="h3 mb-0 text-gray-800">DataTables Employees <?php echo $ct['name_divisi']?> </h1>
             <?php
                        }
                      ?>
            <ol class="breadcrumb">
             ...
             <button  class="btn btn-primary btn-icon-split" data-toggle="modal" data-target="#tambahmembers" id="#modalCenter" >
                    ...
                    <span class="text">Added Employee </span>
                </button>
          </div>
                      ...
                      <?php foreach($data as $a)            
                        {
                          ...
                          ?>
                            ...
                            <tr>
                              ...
                              <td><?php echo $a['id_login']?></td>
                              <td><?php echo $a['username']?></td>
                              <td><?php echo $a['name_divisi']?></td>
                              <td><?php echo $a['password']?></td>
                              
                              <td><a href="<?php echo base_url('admin/admin/tampil_edit_employee')?>?id_login=<?php echo $a['id_login']?>" class="btn btn-info"  ><i class="fas fa-info-circle"></i></a>
                                  <a href="<?php echo base_url('admin/aksi_admin/hapus_data_employee')?>?id_login=<?php echo $a['id_login']?>&name_divisi=<?php echo $a['name_divisi'] ?>" class="btn btn-danger" ><i class="fas fa-trash"></i></a>
                              </td>
                            </tr>
                      <?php
                        }
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                 <?php
                            ...
                            {
                              ?>
                <form action="<?php echo base_url('admin/aksi_admin/do_tambah_employee')?>?&name_divisi=<?php echo $ct['name_divisi'] ?>" method="post">
