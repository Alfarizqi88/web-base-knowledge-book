        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Form Update</h1>
              <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/admin/list_data_case')?>">Back to Data Case</a></li>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <label for="exampleInputEmail1">Id Case</label>
                      <input type="text" class="form-control" id="id" aria-describedby="" required="">
                    </div>


                  <div class="form-group">
                      <label for="exampleInputEmail1">Title Case</label>
                      <input type="text" class="form-control" id="id" aria-describedby="" required="">
                    </div>
