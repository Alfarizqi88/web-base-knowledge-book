                      ...
                      <?php foreach($data as $a)            
                        {
                          ...
                          ?>
                            ...
                            <tr>
                              ...
                              <td><a href="<?php echo base_url('admin/admin/tampil_edit_divisi')?>?id_divisi=<?php echo $a['id_divisi']?>" class="btn btn-info"   ><i class="fas fa-info-circle"></i></a>
                                  <a href="<?php echo base_url('admin/aksi_admin/hapus_data_divisi')?>?id_divisi=<?php echo $a['id_divisi']?>" class="btn btn-danger" ><i class="fas fa-trash"></i></a>
