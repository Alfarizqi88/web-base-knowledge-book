			...
			<div class="hero-wrap js-fullheight" style="background-image: url(<?php echo base_url();?>assets/images/bg_1.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="js-fullheight d-flex justify-content-center align-items-center">
					<div class="col-md-8 text text-center">
						<div class="">
              <img src="assets/images/logosisi.png"/>
            </div>
            <div class="desc">
              <h2 class="subheading">PT SINERGI INFORMATIKA SEMEN INDONESIA</h2>
              <h1 class="subheading">Knowladge</h1>
            </div>
					</div>
				</div>
			</div>
